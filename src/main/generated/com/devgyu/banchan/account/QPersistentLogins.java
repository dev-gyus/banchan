...
public class QPersistentLogins extends EntityPathBase<PersistentLogins> {
    ...
    private static final long serialVersionUID = 923462594L;

    public static final QPersistentLogins persistentLogins = new QPersistentLogins("persistentLogins");

    public final DateTimePath<java.time.LocalDateTime> last_used = createDateTime("last_used", java.time.LocalDateTime.class);
